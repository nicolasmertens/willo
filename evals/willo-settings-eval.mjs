...
ok("faces hint not photo-first", ui.indexOf("Foto erbij, dan aan") === -1);
ok("empty section asks for taal", ui.indexOf("Zet eerst een taal aan") !== -1);
...
ok("index no transform center", index.indexOf("translate(-50%, -50%)") === -1);
ok("again button appearance none", index.indexOf("-webkit-appearance: none") !== -1);
ok("again button min 48", index.indexOf("min-height: 48px") !== -1);
