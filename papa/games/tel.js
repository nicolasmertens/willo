/* Shared telemetry for the mama kids mini-apps.
   Same endpoint as the main app so events correlate per device.
   Each page sets window.TEL_APP (e.g. "mama-soundboard-v1") BEFORE loading this. */
(function () {
  var APP = window.TEL_APP || "mama-game";
  var TEL_URL = "https://liedjes-logger.super-mud-e2ef.workers.dev/log";
  var DEVICE_KEY = "mama_device_id_v1";          // shared with the mama app
  var BUFFER_KEY = "mamagames_tel_buffer_v1";
